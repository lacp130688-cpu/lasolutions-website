        ...
        headers: [
          {
            ...
            value:
              "default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src https://fonts.gstatic.com; img-src 'self' data: blob: https:; connect-src 'self' https://qyyyeiyjqwsfaqwazfgb.supabase.co; frame-ancestors 'none'; base-uri 'self'; form-action 'self'",
          },
          {
