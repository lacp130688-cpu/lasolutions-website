        ...
        headers: [
          {
            ...
            value:
              "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src https://fonts.gstatic.com; img-src 'self' data: blob: https:; connect-src 'self' https://lafdevrlrecenzsiqzvl.supabase.co; frame-ancestors 'none'; base-uri 'self'; form-action 'self'",
          },
          {
